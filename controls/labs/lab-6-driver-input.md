...
If you completed [As the Wheel Turns](lab-5-turn-wheel.md), the only new element is the joystick or controller.

### Software

What we need to do to accomplish the objective:

* Create an Timed Robot template project or open your [As the Wheel Turns](lab-5-turn-wheel.md) project.
...
Think back to the post-lab questions in [As the Wheel Turns](lab-5-turn-wheel.md) (If you haven't done it yet, go read it).
